...
//  Yelp
//
//  Created by Matt Cline on 4/21/15.
...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, limit: Int, offset: Int, completion: ([Business]!, NSError!) -> Void) -> Void {
